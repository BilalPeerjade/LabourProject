...
/*	public static WebElement Clear( )		//Method for closing Message Popup
	...
	{
		clients = getDriver().findElement(By.xpath("//div[@class='month-number number-overdue'][normalize-space()='19']"));
		return clients;
	}
...
*/	
	public static WebElement readTotalItemsNotice() {
	    List<By> locators = Arrays.asList(
	        By.xpath("/html/body/app-root/div/app-layout/section/div/div/app-notice-client-portal/kendo-grid/kendo-pager/kendo-pager-info"),
...
*/	
	...
	public static WebElement read() {
	    List<By> locators = Arrays.asList(
	        ...
	        By.cssSelector("body > app-root > div > app-layout > section > div > div > app-client-dashboard > div:nth-child(2) > div:nth-child(7) > div > div > app-cd-daily-updates > div > div > div > div > div:nth-child(1) > a"),
	        By.xpath(""),
	        By.xpath("")     );
