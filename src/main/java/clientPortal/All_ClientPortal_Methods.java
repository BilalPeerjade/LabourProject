...
//	jse.executeScript("arguments[0].click();", ViewButton);
		...
		Thread.sleep(6000);
		All_ClientPortal_Locators.clickExport_compliancedetails().click();
 ...
 /* 		All_ClientPortal_Locators.SelectEntity().click();
	...
	//  	All_ClientPortal_Locators.EntityTri1().click();
		...
		*/
   		...
   		Thread.sleep(3000);
   		Robot robot=new Robot();
   		 StringSelection filepath= new  StringSelection("C:\\Users\\bilali\\Downloads\\Sample-MonthlySalary_Valid Data.xlsx");
   		 //copy above file to clipboard
   		 Toolkit.getDefaultToolkit().getSystemClipboard().setContents(filepath, null);
...
//       All_ClientPortal_Locators.Apply();
		...
		if (text1.equalsIgnoreCase("Other File uploaded successfully")) {
			Thread.sleep(5000);
			test.log(LogStatus.PASS, "Message Displayed : " + text1);
