...
public class DistributerLocators extends BasePage
{
	...
	public static WebElement ValidationMsg()		//Method for searching Username input
	{
	...
	{
		labour = getDriver().findElement(By.xpath("(//*[@role='combobox'])[3]"));
		return labour;
	}
	...
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-svg-i-calendar k-button-icon k-svg-icon k-icon ng-star-inserted'])[3]"));
		return labour;
	}
	public static WebElement clickCalender4()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-svg-i-calendar k-button-icon k-svg-icon k-icon ng-star-inserted'])[4]"));
		return labour;
	}
	...
	public static WebElement selectweekHourseFrom()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-list-item-text ng-star-inserted'])[37]"));
		return labour;
	}
	...
	public static WebElement selectweekHourseTo()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-list-item-text ng-star-inserted'])[73]"));
		return labour;
	}
	...
	public static WebElement selectIntervalFrom()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-list-item-text ng-star-inserted'])[57]"));
		return labour;
	}
	...
	public static WebElement selectIntervalTo()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-list-item-text ng-star-inserted'])[57]"));
		return labour;
	}
