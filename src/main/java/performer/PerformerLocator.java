...
private static WebElement labour = null;			//WebElement variable created for Username input 
	...
	public static WebElement selectPTState()		//Method for searching Username input
	{
	...
	public static WebElement clickPFCappingApplicability()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-svg-i-caret-alt-down k-button-icon k-svg-icon k-icon ng-star-inserted'])[10]"));
		return labour;
	}
	...
	{
		labour = getDriver().findElement(By.xpath("(//*[@class='k-input-value-text'])[20]"));
		return labour;
	}
	...
	{
		labour = getDriver().findElement(By.xpath("(//span[@class=\"k-input-value-text\"])[6]"));
		return labour;
	}
	public static WebElement clickEmpType1()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("(//span[@class='k-input-value-text'])[9]"));
		return labour;
	}
	public static WebElement selectEmpType1()		//Method for searching Username input
	{
		labour = getDriver().findElement(By.xpath("//span[@class='k-list-item-text ng-star-inserted'][normalize-space()='Core']"));
		return labour;
	}
	...
	public static WebElement clickBrowse()		//Method for searching Username input
	{
